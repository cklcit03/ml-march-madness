...
# Apply ML methods to predict outcome of 2017 NCAA Tournament
...
def main():
    ...
    teams = numpy.genfromtxt("teams_2017.csv", delimiter=",")
    team_ids = teams[1:, 0]
    print("Loading regular season results.")
    regular_season_results = (
        numpy.genfromtxt("regular_season_results_2017.csv",
                         delimiter=","))
    print("Loading tournament results.")
    tourney_results = numpy.genfromtxt("tourney_results_prev_2017.csv",
                                       delimiter=",")
    print("Loading current tournament results.")
    curr_tourney_results = numpy.genfromtxt("tourney_results_2017.csv",
                                            delimiter=",")
    print("Loading KenPom data.")
    kenpom_data = numpy.genfromtxt("kenpom_2017.csv", delimiter=",")
    ...
    curr_file_name = "curr_submission_2017.csv"
    ...
    curr_tourney_teams = numpy.union1d(curr_tourney_winners,
                                       curr_tourney_losers)
    curr_first_four_losers = numpy.array([1300, 1309, 1344, 1448])
